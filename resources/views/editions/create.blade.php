...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
        ...
        <h2 class="text-center">Создать выпуск</h2>
        <hr>

        <form class="form-horizontal" action="{{ url('editions')}}" method="POST">
            {{ csrf_field() }}
            ...
            <div class="form-group {{ $errors->has('amount') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" name="amount" class="form-control input-sm" id="amount" value="{{ old('amount') }}" autofocus>
